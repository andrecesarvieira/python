...
from modulos.gui_guia_aluno import GuiaAlunos
...
class JanelaPrincipal():
  ...
  def criar(self):
    ...
    frame_logo = ttk.Frame(self.root, width=1280, height=72, relief='raised',style='custom.TFrame')
    frame_logo.config(borderwidth=1)
    ...
    frame_toast = ttk.Frame(self.root, width=1276, height=20, style='Teste.TFrame', relief='flat')
    frame_toast.grid(row=2, column=0, columnspan=2, pady=0, padx=1, sticky='s')
    ...
    # Definir tema styles para o bootstrap
    style.theme_create(
